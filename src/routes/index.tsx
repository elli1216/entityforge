    ...
    <div className="mx-auto mt-14 w-full max-w-5xl text-left">
      ...
      >
        ...
        <div
          ...
          style={{ borderColor: 'var(--line)', backgroundColor: 'var(--header-bg)' }}
        >
          <div className="flex items-center gap-2 font-mono text-xs text-(--java-muted)">
            <Code2 className="size-4 text-(--java-orange)" />
            <span className="font-semibold text-(--java-dark)">Visual Entity Model</span>
            <span className="text-gray-400">→</span>
            <span className="font-semibold text-(--java-blue)">Generated Production Code</span>
          </div>
        ...
        <div className="grid lg:grid-cols-12 divide-y lg:divide-y-0 lg:divide-x" style={{ borderColor: 'var(--line)' }}>
            ...
            <div className="rounded-xl border-2 border-(--line) shadow-md overflow-hidden bg-(--java-cream)">
              ...
              >
                <div className="flex items-center justify-between text-[10px] font-mono text-white/80 mb-1">
                  ...
                  <span className="rounded bg-black/20 px-1.5 py-0.2">JPA Model</span>
                </div>
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-mono text-sm font-bold text-white">Customer</span>
                </div>
              </div>
              ...
              <div className="divide-y divide-line font-mono text-xs text-left">
                <div className="flex items-center justify-between px-3 py-2 bg-black/2 dark:bg-white/2">
                  <div className="flex items-center gap-1.5">
                    ...
                    <span className="text-(--java-blue) font-semibold">UUID</span>
                ...
                <div className="flex items-center justify-between px-3 py-2">
                  <div className="flex items-center gap-1.5">
                    <span className="text-rose-500 font-bold">-</span>
                    <span className="text-(--java-blue) font-semibold">String</span>
                    <span className="font-semibold text-(--java-dark)">email</span>
                  </div>
                  <div className="flex items-center gap-1 text-[9px] font-bold">
                    <span className="rounded bg-(--java-blue)/20 px-1.5 py-0.5 text-(--java-blue)">NN</span>
                    <span className="rounded bg-amber-500/20 px-1.5 py-0.5 text-amber-600 dark:text-amber-400">UN</span>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between px-3 py-2 bg-black/2 dark:bg-white/2">
                  <div className="flex items-center gap-1.5">
                    <span className="text-rose-500 font-bold">-</span>
                    <span className="text-(--java-blue) font-semibold">String</span>
                    <span className="font-semibold text-(--java-dark)">fullName</span>
                  </div>
                ...
                <div className="flex items-center justify-between px-3 py-2">
                  <div className="flex items-center gap-1.5">
                    <span className="text-rose-500 font-bold">-</span>
                    <span className="text-(--java-orange-deep) font-semibold">CustomerTier</span>
                    <span className="font-semibold text-(--java-dark)">tier</span>
                  </div>
                ...
                <div className="flex items-center justify-between px-3 py-2 bg-black/2 dark:bg-white/2">
                  <div className="flex items-center gap-1.5">
                    <span className="text-rose-500 font-bold">-</span>
                    <span className="text-(--spring-green) font-semibold">List&lt;Order&gt;</span>
                    <span className="font-semibold text-(--java-dark)">orders</span>
                  </div>
              ...
              <div className="border-t border-line px-3 py-2 bg-black/5 dark:bg-white/5 font-mono text-[10px] text-left">
                <div className="flex items-center justify-between text-(--java-muted)">
                  <span>@Index: <strong className="text-(--java-dark)">idx_customer_email</strong></span>
                  <span className="text-emerald-600 dark:text-emerald-400 font-bold">UNIQUE</span>
                </div>
              </div>
            </div>
  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1">
        {/* Hero Section */}
        <section className="page-wrap relative pt-16 pb-20 md:pt-24 md:pb-28">
          <div className="mx-auto max-w-4xl text-center">
            {/* Java Annotation Pill */}
            <div
              className="inline-flex items-center gap-2 rounded-full border px-3.5 py-1.5 text-xs font-mono font-semibold backdrop-blur-md shadow-xs"
              style={{
                borderColor: 'var(--oop-badge-border)',
                backgroundColor: 'var(--oop-badge-bg)',
                color: 'var(--java-orange)',
              }}
            >
              <span className="flex h-2 w-2 rounded-full bg-(--spring-green) animate-pulse" />
              <span>@SpringBootApplication • Jakarta Persistence 3.1</span>
            </div>

            <h1 className="mt-6 display-title text-3xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold tracking-tight leading-[1.15]">
              Visually Model{' '}
              <span style={{ color: 'var(--java-orange)' }}>Java OOP Entities</span>{' '}
              with Zero Latency
            </h1>

            <p
              className="mx-auto mt-4 sm:mt-6 max-w-2xl text-sm sm:text-base md:text-xl leading-relaxed"
              style={{ color: 'var(--java-muted)' }}
            >
              Design database schemas like real Java class hierarchies. Drag-and-drop entities, map object associations, and compile production-ready Spring Data JPA domain models & Flyway DDL directly in your browser.
            </p>

            <div className="mt-6 sm:mt-8 flex flex-col sm:flex-row items-stretch sm:items-center justify-center gap-3 sm:gap-4">
              <Link
                to="/workspace"
                className="group inline-flex items-center justify-center gap-2.5 rounded-xl px-6 py-3.5 text-sm font-bold text-white shadow-xl transition-all hover:-translate-y-0.5 hover:shadow-2xl"
                style={{
                  background: 'linear-gradient(135deg, var(--java-orange), var(--java-orange-deep))',
                  boxShadow: '0 6px 24px rgba(237, 139, 0, 0.4)',
                }}
              >
                <Code2 className="size-4 transition-transform group-hover:scale-110" />
                <span>Open Canvas Studio</span>
                <ArrowRight className="size-4 transition-transform group-hover:translate-x-1" />
              </Link>
              <Link
                to="/documentation"
                className="inline-flex items-center justify-center gap-2 rounded-xl border px-6 py-3.5 text-sm font-semibold transition-all hover:-translate-y-0.5 hover:bg-black/5 dark:hover:bg-white/5"
                style={{
                  borderColor: 'var(--line)',
                  color: 'var(--java-dark)',
        ...
        <section className="page-wrap py-14 sm:py-20 border-t" style={{ borderColor: 'var(--line)' }}>
          <div className="mx-auto max-w-3xl text-center px-4">
            ...
            <p className="mt-3 text-xs sm:text-sm md:text-base" style={{ color: 'var(--java-muted)' }}>
              EntityForge brings modern Java domain-driven design into an intuitive visual graph.
            </p>
          </div>
          ...
          <div className="mt-8 sm:mt-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            <div className="feature-card rounded-2xl p-5 sm:p-6 relative overflow-hidden">
              ...
              <div className="font-mono text-xs text-(--java-orange) font-semibold">@Entity & Properties</div>
              <h3 className="mt-1 text-base font-bold">Encapsulation</h3>
              <p className="mt-2 text-xs leading-relaxed" style={{ color: 'var(--java-muted)' }}>
                Declare strongly-typed fields (`UUID`, `Instant`, `BigDecimal`, Enums) with strict constraints (`PK`, `Unique`, `Nullable`) and auto-generated Java accessors.
              </p>
            </div>
            ...
            <div className="feature-card rounded-2xl p-5 sm:p-6 relative overflow-hidden">
              ...
              <div className="font-mono text-xs text-(--java-blue) font-semibold">@ManyToOne / @OneToMany</div>
              <h3 className="mt-1 text-base font-bold">Object Associations</h3>
              <p className="mt-2 text-xs leading-relaxed" style={{ color: 'var(--java-muted)' }}>
                Visually connect entities with UML-style relationships (`1:N`, `N:1`, `1:1`, `M:M`), automatic `@JoinColumn` injection, and collection mapping.
              </p>
            </div>
            ...
            <div className="feature-card rounded-2xl p-5 sm:p-6 relative overflow-hidden">
              ...
              <div className="font-mono text-xs text-(--spring-green) font-semibold">@Index & Flyway DDL</div>
              <h3 className="mt-1 text-base font-bold">Schema Persistence</h3>
              <p className="mt-2 text-xs leading-relaxed" style={{ color: 'var(--java-muted)' }}>
                Transform class diagrams into pure, dialect-specific SQL migrations (`CREATE TABLE`, foreign key constraints, composite indexes) for PostgreSQL & MySQL.
              </p>
            </div>
            ...
            <div className="feature-card rounded-2xl p-5 sm:p-6 relative overflow-hidden">
              ...
              <div className="font-mono text-xs text-(--java-orange-deep) font-semibold">pom.xml + Maven Wrapper</div>
              <h3 className="mt-1 text-base font-bold">Maven ZIP Builder</h3>
              <p className="mt-2 text-xs leading-relaxed" style={{ color: 'var(--java-muted)' }}>
                Export a ready-to-run Spring Boot Maven project complete with `mvnw`, tests, configuration profiles (`application-dev.properties`), and models in one click.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="page-wrap py-14 sm:py-20 border-t" style={{ borderColor: 'var(--line)' }}>
          ...
          <div className="mt-8 sm:mt-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            {[
              { step: '01', title: 'Define Class Hierarchy', badge: 'public class', desc: 'Instantiate entity nodes on canvas, add typed attributes, and configure database table names.' },
              { step: '02', title: 'Link Associations', badge: '@Relationship', desc: 'Drag Bezier edges between nodes to define JPA cardinality and foreign key cascading.' },
              { step: '03', title: 'Inspect Real-time Code', badge: '.java & .sql', desc: 'Watch Java entity sources and Flyway migration scripts compile synchronously in memory.' },
              { step: '04', title: 'Compile & Execute', badge: 'mvn spring-boot:run', desc: 'Download standard Maven zip archive and start building your Spring Boot application immediately.' },
            ].map(({ step, title, badge, desc }) => (
              <div key={step} className="java-class-card p-5 sm:p-6 relative group transition-all hover:-translate-y-1">
                <div className="flex items-center justify-between mb-4">
                  <span className="text-xl sm:text-2xl font-extrabold font-mono text-(--java-orange)">{step}</span>
                  <span className="java-chip text-[10px] text-(--java-muted)">{badge}</span>
                </div>
                <h3 className="text-sm sm:text-base font-bold mb-2">{title}</h3>
                <p className="text-xs leading-relaxed" style={{ color: 'var(--java-muted)' }}>
                  {desc}
                </p>
              </div>
            ))}
            ...
            <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-6 sm:gap-8">
              <div className="text-left max-w-xl">
                ...
                <p className="mt-2 sm:mt-3 text-xs sm:text-sm md:text-base text-white/80 leading-relaxed">
                  No sign-up, zero server delays, completely secure and private in your browser.
                </p>
              </div>
      ...
      <footer className="site-footer px-6 py-8 text-center text-xs" style={{ color: 'var(--java-muted)' }}>
